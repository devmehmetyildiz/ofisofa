    ...
    <div className='w-full flex justify-center items-center mb-12'>
      <div className=' w-full lg:w-2/3'>
        <div className='flex flex-col justify-start items-start'>
          <h1 className='font-bold text-xl text-[#1c2520] mt-4'>Bizimle İletişime Geç</h1>
          <div className='flex flex-col lg:flex-row justify-between items-center w-full mt-4'>
            ...
            <div className='flex flex-col justify-start items-start '>
              <div className='flex flex-row justify-start items-center w-full my-4'>
                <CiHome className='mr-8 text-4xl text-[#1c2520]' />
                <div className='flex flex-col justify-center items-start'>
                  <h1 className='text-[#1c2520] font-semibold'>Mücahitler Mahallesi 52075.Sokak </h1>
                  <h1 className='text-[#1c2520] font-semibold'> Kuğu Apartmanı No: 12/A </h1>
                  <h2 className='text-[#1c2520]'>Şehitkamil/Gaziantep</h2>
                </div>
              </div>
              <div className='flex flex-row justify-start items-center w-full my-4'>
                <CiMobile4 className='mr-8 text-4xl text-[#1c2520]' />
                <div className='flex flex-col justify-center items-start'>
                  <h1 className='text-[#1c2520] font-semibold'>0 (530) 364 8963</h1>
                  <h2 className='text-[#1c2520]'>7/24 Her zaman</h2>
                </div>
              </div>
              <div className='flex flex-row justify-start items-center w-full my-4'>
                <AiOutlineMail className='mr-8 text-4xl text-[#1c2520]' />
                <div className='flex flex-col justify-center items-start'>
                  <h1 className='text-[#1c2520] font-semibold'>info@ofisofa.com</h1>
                  <h2 className='text-[#1c2520]'>Her zaman bize ulaşabilirsiniz!</h2>
                </div>
              </div>
            </div>
          </div>
