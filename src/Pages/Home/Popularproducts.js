    ...
    <div className='w-full justify-center items-center flex flex-col mt-12'>
      <div className='overflow-hidden'>
        <motion.h1
          ...
          className='font-bold uppercase text-center text-4xl'>Popüler Ürünler</motion.h1>
      </div>
      <div className='overflow-hidden'>
        <motion.p
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className='mt-4 text-center text-[#7F85A8] font-normal text-lg'>En beğenilir Modellerimiz</motion.p>
