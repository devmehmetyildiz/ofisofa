...
export default function Portfolio() {
  ...
  return (
    <div className=' relative w-full flex justify-center items-center bg-[#144E5A] h-[100vh]'>
      ...
      <div className='p-2 rounded-lg absolute left-[15%] top-[25%]  bg-[#ffe2c8]/60 w-2/3 lg:w-1/3'>
        <div className='p-[1%] lg:p-[5%] flex flex-col justify-center items-start'>
          <h1 className='text-[#144E5A] text-[2.3vmin] lg:text-[3.4vmin] font-bold uppercase mb-4'>SİZLER İÇİN</h1>
          <h1 className='text-[3.4vmin] lg:text-[5.4vmin] text-[#1c2520] font-extrabold leading-[1.2] mb-4'>YENİ SİTEMİZLE YAYINDAYIZ</h1>
