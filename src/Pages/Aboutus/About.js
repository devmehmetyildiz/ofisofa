...
export default function About() {
  return (
    <div className='mt-12 px-[10%] flex flex-col justify-center items-center text-center'>
      <h1 className='text-4xl text-[#000000] font-bold mt-12'>BİZ KİMİZ?</h1>
      ...
      <h1 className='text-4xl text-[#000000] font-bold mt-12'>VİZYON - MİSYON</h1>
      <p className='text-lg text-[#3D3D3D] mt-12 px-[10%]'>
      ...
      <h1 className='text-4xl text-[#000000] font-bold mt-12'>2023</h1>
      <p className='text-lg text-[#3D3D3D] mt-12 px-[10%]'>
